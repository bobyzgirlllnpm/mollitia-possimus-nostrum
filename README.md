# @bobyzgirlllnpm/mollitia-possimus-nostrum
...
```bash
npm install @bobyzgirlllnpm/mollitia-possimus-nostrum
```
...
const { RefResolver } = require('@bobyzgirlllnpm/mollitia-possimus-nostrum')
